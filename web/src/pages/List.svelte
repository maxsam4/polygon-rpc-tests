<script lang="ts">
  ...
  async function addToWallet(provider: Endpoint) {
    ...
    try {
      // Call wallet_addEthereumChain directly
      // If the network exists, MetaMask will show an "Update" dialog
      // If it doesn't exist, MetaMask will add it as a new network
